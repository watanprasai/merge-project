...
// ====================== import หน้า Create Symptom ===============
import SymptomPageCreate from "./components/SymptomCreate";
...
return (
  ...
  <Router>
              <Routes>
                ...
                // =================== เพิ่ม path หน้า Create Symptom ==================
                <Route path="/symptomcreate" element={<SymptomPageCreate />} />
