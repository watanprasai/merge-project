...
///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  function submit() {
   ...
   const apiUrl = "http://localhost:8888/CreatePatient";
...
/////////////////////////////////////////////-_ ส่วนของการโหลดและดึงค่ามาใช้(ใช้กับ Combobox) _-//////////////////////////////////////////////////////////
  ...
  const getBlood_type = async () => {
    const apiUrl = `http://localhost:8888/ListBlood_type`;
    const requestOptions = {
      method: "GET",
  ...
  const getDrug_Allergy= async () => {
    const apiUrl = `http://localhost:8888/ListDrug_Allergy`;
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getGender= async () => {
    const apiUrl = `http://localhost:8888/ListGender`;
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getRIGHTS= async () => {
    const apiUrl = `http://localhost:8888/ListRIGHTS`;
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
