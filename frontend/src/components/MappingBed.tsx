...
function MappingBedCreate() {
  ...
  */
  ...
  async function submit() {
    ...
    const apiUrl = "http://localhost:8888/CreateMapBed";
    ...
    const UpdateBedstate = async () => {
      const apiUrl = "http://localhost:8888/UpdateBedstate";
      const requestOptions = {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
    ...
    const UpdateTriagestate = async () => {
      const apiUrl = "http://localhost:8888/UpdateTriagestate";
      const requestOptions = {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
    ...
    //             .then((response) => response.json())
    //             .then((res) => {});
    const apiUrlPatchTriage = "http://localhost:8888/UpdateTriagestate";
  ...
  //function Search
  function search() {
    const apiUrl1 = `http://localhost:8888/GetTriage/${triageID}`;
  ...
  const getMappigBed = async () => {
    const apiUrl = "http://localhost:8888/GetListMapBeds";
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getTriages = async () => {
    const apiUrl = "http://localhost:8888/GetListTriages";
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getZone = async () => {
    const apiUrl = "http://localhost:8888/GetListZones";
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getBed = async () => {
    const apiUrl = `http://localhost:8888/Bed/${zoneID}`;
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
  ...
  const getUser = async () => {
    const apiUrl = `http://localhost:8888/user/${userID}`;
    const requestOptions = {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    };
