...
//function Submit
      ...
      async function submit() {
            ...
            const apiUrl = "http://localhost:8888/CreateTriage";
            ...
            const UpdatePatientstate = async () => {
                  const apiUrl = "http://localhost:8888/UpdatePatientstate";
                  const requestOptions = {
                  method: "PATCH",
                  headers: { "Content-Type": "application/json" },
...
//function Search
      function search() { 
            const apiUrl1 = `http://localhost:8888/GetPatient/${patientID}`;
...
//function fethch data จาก backend
      ...
      const getPatients = async () => {
            const apiUrl = "http://localhost:8888/ListPatient";
            const requestOptions = {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            };
      ...
      const getDisease = async () => {
            const apiUrl = "http://localhost:8888/GetListDisease";
            const requestOptions = {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            };
      ...
      const getInpantientDepartment = async () => {
            const apiUrl = "http://localhost:8888/GetListIPDs";
            const requestOptions = {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            };
